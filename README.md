...
```sh
make build-installer IMG=<some-registry>/pod-identity-reloader:tag
```
...
```sh
kubectl apply -f https://raw.githubusercontent.com/<org>/pod-identity-reloader/<tag or branch>/dist/install.yaml
```
