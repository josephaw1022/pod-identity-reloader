...
import (
	...
	"github.com/josephaw1022/pod-identity-reloader/internal/controller"
...
func main() {
	...
	if clusterName == "" {
		setupLog.Error(nil, "--cluster-name is required")
		os.Exit(1)
	}
	...
	lookup := podidentity.NewEKSLookup(eks.NewFromConfig(awsCfg))
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "d51af5b2.josephaw1022.dev",
